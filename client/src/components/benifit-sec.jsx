...
const BenefitsSec = () => {
  ...
  return (
    <section className="pt-10 pb-5 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <Heading
            ...
            description={
              <>
                We&apos;re committed to providing you with the highest quality nutrition supplements <br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 items-center mb-8">
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-6">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="p-6 bg-white rounded shadow hover:shadow-xl transition-all duration-300 border border-gray-100 h-full group-hover:border-gray-200">
                  <div className="flex flex-col space-y-2 md:space-y-4">
                    <motion.div
                      className={`${benefit.color} ${benefit.hoverColor} text-white p-3 md:p-4 rounded w-fit transition-all duration-300`}
                      whileHover={{ rotate: 5, scale: 1.1 }}
                    >
                      {benefit.icon}
                    </motion.div>
                    <div>
                      <h3 className="text-base md:text-xl font-bold mb-3 text-gray-900 group-hover:text-gray-800 transition-colors">
                        {benefit.title}
                      </h3>
                      <p className="text-gray-600 leading-relaxed text-xs md:text-sm group-hover:text-gray-700 transition-colors">
                        {benefit.description}
                      </p>
                    </div>
                  </div>
          ...
          >
            <motion.div
              className="aspect-square rounded overflow-hidden relative shadow  mx-auto"
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="bg-white rounded p-4 md:p-8"
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
            {certifications.map((cert, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="text-center p-4 rounded bg-gray-100 hover:bg-gray-50 transition-colors group"
                whileHover={{ scale: 1.05 }}
              >
                <div className="w-10 h-10 bg-black rounded flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
