  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | Being Genuine Nutrition",
          metaDescription:
  ...
  try {
    ...
    if (contactContent) {
      const contactData = {
        ...
        socialLinks: {
          facebook: "https://facebook.com/beinggenuinenutrition",
          instagram: "https://instagram.com/beinggenuinenutrition",
          twitter: "https://twitter.com/beinggenuinenutrition",
        },
      };
    ...
    const contactInfo = {
      ...
      metaTitle: "Contact Us | Being Genuine Nutrition",
      metaDescription:
